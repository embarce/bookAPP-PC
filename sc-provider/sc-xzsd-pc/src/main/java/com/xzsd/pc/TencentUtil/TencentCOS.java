...
public class TencentCOS {
    ...
    // secretId
    private static final String secretId = "AKIDdz3qNdtLlkZ5KGsRaR8bppZ9SUXKCBDy";
    // secretKey
    private static final String secretKey = "cw6y71ez3pJVkiQlxrviDRP5TdVHm32k";
    ...
    public static String uploadfile(File localFile) throws CosClientException, CosServiceException {
        ...
        try {
            ...
            // 指定要上传到 COS 上的路径
            fileName = "test/"+random.nextInt(10000) + System.currentTimeMillis() + substring;
        ...
        return "https://test-1300625833.cos.ap-guangzhou.myqcloud.com/"+fileName;
    }
